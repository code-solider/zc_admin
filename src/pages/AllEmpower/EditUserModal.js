...
class NormalLoginForm extends Component {
    handleSubmit = e => {
        ...
        this.props.form.validateFields(async (err, values) => {
            if (!err) {
                ...
                values.ids = allagent.updateUserInfo.id;
                dispatch({
                    type: 'allagent/updateUser',
                    payload: values
                })
            }
        });
    ...
    render() {
        ...
        let { allagent: { updateUserInfo } } = this.props;
            ...
            <Form onSubmit={this.handleSubmit} className="login-form" {...formItemLayout}>
                <Form.Item label="用户名称">
                    {getFieldDecorator('nickname', {
                        ...
                        initialValue: updateUserInfo ? updateUserInfo.nickname : ''
                    })(
                        <Input
                ...
                <Form.Item label="手机号码">
                    {getFieldDecorator('mobile', {
                        ...
                        initialValue: updateUserInfo ? updateUserInfo.mobile : ''
                    })(
                        <Input
                ...
                <Form.Item label="到期时间">
                    {getFieldDecorator('end_time', {
                        ...
                        initialValue: moment(updateUserInfo ? updateUserInfo.end_time : '', 'YYYY-MM-DD HH:mm:ss')
                    })(
                        <DatePicker showTime />,
                    )}
                </Form.Item>
...
class EditUserModal extends Component {
    ...
    render() {
        let { allagent: { showEditUserModal } } = this.props;
        return (
            <Modal
                title="添加用户"
